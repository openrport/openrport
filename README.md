...
```
wget https://github.com/cloudradar-monitoring/rport/releases/download/0.1.26/rport_0.1.26_Linux_x86_64.tar.gz
sudo tar vxzf rport_0.1.26_Linux_x86_64.tar.gz rportd
...
```
wget https://github.com/cloudradar-monitoring/rport/releases/download/0.1.26/rport_0.1.26_Linux_x86_64.tar.gz
sudo tar vxzf rport_0.1.26_Linux_x86_64.tar.gz -C /usr/local/bin/ rportd
...
sudo tar vxzf rport_0.1.26_Linux_x86_64.tar.gz -C /etc/rport/ rportd.example.conf
...
```
curl -LSs https://github.com/cloudradar-monitoring/rport/releases/download/0.1.26/rport_0.1.26_Linux_x86_64.tar.gz|\
...
```
wget https://github.com/cloudradar-monitoring/rport/releases/download/0.1.26/rport_0.1.26_Linux_x86_64.tar.gz
sudo tar vxzf rport_0.1.26_Linux_x86_64.tar.gz -C /usr/local/bin/ rport
sudo useradd -d /var/lib/rport -U -m -r -s /bin/false rport
sudo mkdir /etc/rport/
sudo mkdir /var/log/rport/
sudo chown rport /var/log/rport/
sudo tar vxzf rport_0.1.26_Linux_x86_64.tar.gz -C /etc/rport/ rport.example.conf
...
On Microsoft Windows [download the latest client binary](https://github.com/cloudradar-monitoring/rport/releases/download/0.1.26/rport_0.1.26_Windows_x86_64.zip) and extract it ideally to `C:\Program Files\rport`. Rename the `rport.example.conf` to `rport.conf` and store it in `C:\Program Files\rport` too.
