...
func _001_initUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "001_init.up.sql", size: 419, mode: os.FileMode(420), modTime: time.Unix(1670500925, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
