...
type Repository interface {
	...
	LogDone(ctx context.Context, details notifications.NotificationDetails) error
	LogError(ctx context.Context, details notifications.NotificationDetails, out string) error
...
func (r repository) LogError(ctx context.Context, details notifications.NotificationDetails, out string) error {
	details.Out = out
	details.State = notifications.ProcessingStateError
	return r.save(ctx, details)
}

func (r repository) LogDone(ctx context.Context, details notifications.NotificationDetails) error {
